//
//  ABSCustomTextView.swift
//  ABSTracs
//
//  Created by Deepali Gupta on 22/09/17.
//  Copyright © 2017 Deepali Gupta. All rights reserved.
//

import UIKit

protocol ABSCustomTextViewDelegate {
    func pressDone()
    func pressCancel()
    func pressCamera()
}
...
class ABSCustomTextView: UITextView {
    
    var placeholderTextViewdelegate:ABSCustomTextViewDelegate?
    ...
    @IBInspectable public var placeholderColor: UIColor = ABSCustomTextView.Constants.defaultiOSPlaceholderColor {
        didSet {
    ...
    func commonInit() {
        NotificationCenter.default.addObserver(self,
                                               selector: #selector(ABSCustomTextView.textDidChange),
        ...
        self.textContainerInset = UIEdgeInsetsMake(10, 15, 0, 0); // top, left, bottom, right --> Padding, Additional line added
    ...
    func addToolBar(){
        ...
        let doneButton = UIBarButtonItem(title: "Done", style: UIBarButtonItemStyle.done, target: self, action: #selector(ABSCustomTextView.donePressed))
        doneButton.tintColor = UIColor.darkGray
        //let cancelButton = UIBarButtonItem(title: "Cancel", style: UIBarButtonItemStyle.plain, target: self, action: #selector(ABSCustomTextView.cancelPressed))
    ...
    private func getCameraBarButton() -> UIBarButtonItem {
        ...
        cameraButton.addTarget(self, action: #selector(ABSCustomTextView.cameraPressed), for: .touchUpInside)
