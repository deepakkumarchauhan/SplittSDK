...
extension UIImageView {
    ...
    func downloadedFrom(url: URL, contentMode mode: UIViewContentMode = .scaleAspectFit, placeholderImage: UIImage) {
        // check for cache
...
extension UIImage {
    func fixOrientation() -> UIImage {
        ...
        // No-op if the orientati on is already correct
...
extension Date {
    ...
    func offsetPop(date: Date) -> String {
...
extension UIButton {
    ...
    func getURL2(url: URL, contentMode mode: UIViewContentMode = .scaleAspectFit, placeholderImage: UIImage) {
        contentMode = mode
        URLSession.shared.dataTask(with: url) { data, response, error in
            guard
                let httpURLResponse = response as? HTTPURLResponse, httpURLResponse.statusCode == 200,
    ...
    func downloadedFrom2(link: String, contentMode mode: UIViewContentMode = .scaleToFill, placeholderImage: UIImage) {
        guard let url = URL(string: link) else { return }
        getURL2(url: url, contentMode: mode, placeholderImage: placeholderImage)
    }
